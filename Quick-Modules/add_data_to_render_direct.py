"""
Add test data directly to Render PostgreSQL from local machine
This script connects to Render's PostgreSQL without needing shell access
"""
import os
...
# Get Render DATABASE_URL from .env
RENDER_DB_URL = os.getenv("DATABASE_URL")

if not RENDER_DB_URL:
    print("ERROR: DATABASE_URL not found in .env")
    print("Make sure your .env file has DATABASE_URL set to Render's PostgreSQL URL")
    exit(1)

# Create Flask app with Render database
...
def add_test_data_to_render():
    """Add test data directly to Render PostgreSQL"""
    print("\n" + "=" * 80)
    print("ADDING TEST DATA TO RENDER POSTGRESQL")
    print("=" * 80)
    print(f"\nDatabase: {RENDER_DB_URL[:50]}...\n")
